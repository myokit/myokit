...
class SimulationOpenMP(myokit.CModule):
    """
    ...
    def __init__(self, model, protocol=None, ncells=50):
        super(SimulationOpenMP, self).__init__()
        ...
        SimulationOpenMP._index += 1
        module_name = 'myokit_simopenmp_'+str(SimulationOpenMP._index)
        # Arguments
        args = {
        ...
        self._sim = self._compile(module_name, fname, args, ['m', 'gomp'],
            libd, incd, ['-fopenmp'])
