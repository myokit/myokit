...
SOURCE_FILE = 'opencl12d_euler_heun.c'
KERNEL_FILE = 'opencl12d_euler_heun.cl'
class SimulationOpenCLEulerHeun(myokit.CModule):
    """
    ...
    has two repercussions:
      ...
      - Models used in a SimulationOpenCLEulerHeun need to have independent
    ...
    def __init__(self, model, protocol=None, ncells=256, npaced=5, g=9.5,
        ...
        super(SimulationOpenCLEulerHeun, self).__init__()
    ...
    def _create_backend(self):
        ...
        SimulationOpenCLEulerHeun._index += 1
        mname = 'myokit_sim_opencl_' + str(SimulationOpenCLEulerHeun._index)
    ...
    def run(self, duration, log=None, log_interval=1.0, progress=None,
        ...
        number indicating the cell index. For example, when using::
            ...
            s = SimulationOpenCLEulerHeun(m, p, ncells=256)
