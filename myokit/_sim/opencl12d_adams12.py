...
SOURCE_FILE = 'opencl12d_adams12.c'
KERNEL_FILE = 'opencl12d_adams12.cl'
class SimulationOpenCLAdams12(myokit.CModule):
    """
    ...
    has two repercussions:
      ...
      - Models used in a SimulationOpenCLAdams12 need to have independent
    ...
    def __init__(self, model, protocol=None, ncells=256, npaced=5, g=9.5,
        ...
        super(SimulationOpenCLAdams12, self).__init__()
    ...
    def _create_backend(self):
        ...
        SimulationOpenCLAdams12._index += 1
        mname = 'myokit_sim_opencl_' + str(SimulationOpenCLAdams12._index)
    ...
    def run(self, duration, log=None, log_interval=1.0, progress=None,
        ...
        - A :class:`DataLog` object or another dictionary of
           ``qname : list`` mappings.
        ...
        number indicating the cell index. For example, when using::
            ...
            s = SimulationOpenCLAdams12(m, p, ncells=256)
