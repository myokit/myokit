...
var_map = {
    PD_model["tempPK"]["Drug_Concentration_Central"]:Auto_PKPD_model["AllCompartment"]["Drug_Concentration_Central"]
}
Auto_PKPD_model.import_component(PD_model["PD"], var_map=var_map, convert_units=True)
