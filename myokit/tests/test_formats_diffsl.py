...
/* Constants: phys */
physZF { 9.64853414999999950e+04 } /* phys.F */
physZR { 8.314472 } /* phys.R */
physZT { 310.0 } /* phys.T */
physZRTF { physZR * physZT / physZF * 1000.0 } /* phys.RTF [mV] */

/* Constants: potassium */
potassiumZKi { 110.0 } /* potassium.Ki */
potassiumZKo { 4.0 } /* potassium.Ko */

/* Constants: voltageclamp */
voltageclampZELeak { -80.0 } /* voltageclamp.ELeak */
voltageclampZVc { 0.0 } /* voltageclamp.Vc [mV] */
voltageclampZalpha { 0.8 } /* voltageclamp.alpha */
voltageclampZcmZest { 0.9 * 100.0 } /* voltageclamp.cm_est */
voltageclampZcprs { 4.0 } /* voltageclamp.cprs */
voltageclampZcprsZest { 4.0 * 0.9 } /* voltageclamp.cprs_est */
voltageclampZgLeak { 2.0 } /* voltageclamp.gLeak */
voltageclampZrseries { 10.0 * 0.001 } /* voltageclamp.rseries */
voltageclampZrseriesZest { 0.9 * 0.01 } /* voltageclamp.rseries_est */
voltageclampZtauZclamp { 0.8 * 0.001 } /* voltageclamp.tau_clamp [ms] */
voltageclampZtauZsum { 0.04 } /* voltageclamp.tau_sum [ms] */
voltageclampZvoffsetZeff { 5.0 } /* voltageclamp.voffset_eff */
voltageclampZdotZIoutZtau { 7.5 * 0.001 } /* voltageclamp.dot_Iout.tau [ms] */

/* Constants: rev */
revZEK { physZRTF * log(potassiumZKo / potassiumZKi) } /* rev.EK [mV] */

/* Constants: ikr */
ikrZg { 0.1524 * 1000.0 } /* ikr.g */
ikrZp1 { 0.000226 } /* ikr.p1 */
ikrZp2 { 0.0699 } /* ikr.p2 */
ikrZp3 { 3.45e-05 } /* ikr.p3 */
ikrZp4 { 0.05462 } /* ikr.p4 */
ikrZp5 { 0.0873 } /* ikr.p5 */
ikrZp6 { 0.00891 } /* ikr.p6 */
ikrZp7 { 0.00515 } /* ikr.p7 */
ikrZp8 { 0.03158 } /* ikr.p8 */

/* Constants: membrane */
membraneZcm { 100.0 } /* membrane.cm */
membraneZdotZVZtau { membraneZcm * voltageclampZrseries } /* membrane.dot_V.tau [ms] */

/* Initial conditions */
u_i {
  membraneZV = -80.0, /* membrane.V [mV] */
  voltageclampZVclamp = -80.0, /* voltageclamp.Vclamp [mV] */
  voltageclampZVp = -80.0, /* voltageclamp.Vp [mV] */
  voltageclampZVest = -80.0, /* voltageclamp.Vest [mV] */
  voltageclampZIout = 0.0, /* voltageclamp.Iout [pA] */
  ikrZopen = 0.0, /* ikr.open [1] */
  ikrZactive = 1.0, /* ikr.active [1] */
}
...
voltageclampZILeak { voltageclampZgLeak * (membraneZV - voltageclampZELeak) } /* voltageclamp.ILeak [pA] */
voltageclampZIin { (voltageclampZVp - membraneZV + voltageclampZvoffsetZeff) / voltageclampZrseries + voltageclampZcprs * voltageclampZdVpdt - voltageclampZcprsZest * voltageclampZdVclampdt - voltageclampZcmZest * (voltageclampZdVclampdt * (1 - heaviside(voltageclampZrseriesZest - 1e-06)) + voltageclampZdVestdt * heaviside(voltageclampZrseriesZest - 1e-06)) } /* voltageclamp.Iin [pA] */

/* Variables: ikr */
ikrZIKr { ikrZg * ikrZopen * ikrZactive * (membraneZV - revZEK) } /* ikr.IKr [pA] */
ikrZdotZactiveZk3 { ikrZp5 * exp(ikrZp6 * membraneZV) } /* ikr.dot_active.k3 */
ikrZdotZactiveZk4 { ikrZp7 * exp(-ikrZp8 * membraneZV) } /* ikr.dot_active.k4 */
ikrZdotZactiveZtau { 1.0 / (ikrZdotZactiveZk3 + ikrZdotZactiveZk4) } /* ikr.dot_active.tau */
ikrZdotZactiveZinf { ikrZdotZactiveZk4 * ikrZdotZactiveZtau } /* ikr.dot_active.inf */
ikrZdotZopenZk1 { ikrZp1 * exp(ikrZp2 * membraneZV) } /* ikr.dot_open.k1 */
ikrZdotZopenZk2 { ikrZp3 * exp(-ikrZp4 * membraneZV) } /* ikr.dot_open.k2 */
ikrZdotZopenZtau { 1.0 / (ikrZdotZopenZk1 + ikrZdotZopenZk2) } /* ikr.dot_open.tau */
ikrZdotZopenZinf { ikrZdotZopenZk1 * ikrZdotZopenZtau } /* ikr.dot_open.inf */

/* Variables: membrane */
membraneZIion { (ikrZIKr + voltageclampZILeak) * 0.01 } /* membrane.Iion [A/F] */
...
G_i {
  (voltageclampZVp - membraneZV + voltageclampZvoffsetZeff) / membraneZdotZVZtau - membraneZIion / 0.01 / membraneZcm,
