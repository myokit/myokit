...
2. [Logging simulation results](1-2-logging-simulation-results.ipynb)
    - [x] Selecting variable by name
    - [x] Logging derivatives
    - [x] Using logging flags
    - [x] Continuing on from a previous simulation
    - [x] Storing results to disk
    - [ ] Selecting which points to log

3. [Starting, stopping, pre-pacing, and loops](1-3-starting-stopping.ipynb)
    - [x] Starting and stoppping simulations
    - [x] Pre-pacing to a "steady state"
    - [x] Simulating the effects of parameter changes
