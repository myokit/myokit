...
- Changed
  ...
  - [#687](https://github.com/MichaelClerx/myokit/pull/687) The method `SimulationOpenCL.shape` now returns a tuple ``(nx, ny)``, consistent with the constructor argument ``ncells``.
