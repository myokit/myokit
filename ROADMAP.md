...
- Improved calculation of "sensitivities" of simulation results with respect to model parameters (#582, #937).
- A rewrite of the HH and Markov model simulations (#808, #700, #701, #736)).
...
- Add new features for working with stimulus protocols ([project](https://github.com/myokit/myokit/projects/999)).
